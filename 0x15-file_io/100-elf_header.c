 ...
 * Description: exit 98 if file is not an ELF format
 */
 ...
 * Description: magic numbrs are separated by space
 */
 ...
 * @e_ident: pointer to array containing the ELD class
 * Return: nothing
 */
...
/**
 * main - Displays the information contined in the ELF header at file starting
 * @argc: number of arguements given to program
